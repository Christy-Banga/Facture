                ...
                <div class="flex flex-wrap -mx-6">
                    ...
                    <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white dark:bg-gray-800">
                            ...
                            <div class="mx-5">
                                <h4 class="text-2xl font-semibold text-gray-700 dark:text-white">{{Totalfacture}}</h4>
                    ...
                    <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                     ...
                     <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white dark:bg-gray-800">
                            ...
                            <div class="mx-5">
                                <h4 class="text-2xl font-semibold text-gray-700 dark:text-white">{{factureNonPayée}}</h4>
